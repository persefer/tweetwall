...
//			  alert(this.query);
            ...
            // Return the full URL
//            alert(protocol + '//' + baseURL + endpoint + '.json?' + queryString + '&include_entities=true&callback=?');
            return protocol + '//' + baseURL + endpoint + '.json?' + queryString + '&include_entities=true&callback=?';
          },
...
/// TWITTER JSON DAN GELENLERI BURADA PARÇALIYORUZ
          ...
          renderTweet: function (tweet) {
            ...
            if (this.settings.showAuthor) {
              html += '<p class="text"><input type="checkbox" value="' + tweet.id + '" class="checkbox" /><span class="username">' + tweet.from_user + ': </span>';
            } else {
              html += '<p class="text"> ';
            }
