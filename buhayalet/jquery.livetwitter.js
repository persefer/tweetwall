...
/// TWITTER JSON DAN GELENLERI BURADA PARÇALIYORUZ
          ...
          renderTweet: function (tweet) {
            ...
            if (this.settings.showAuthor) {
              html += '<p class="text"><input type="checkbox" value="1" onClick="yasakla(' + tweet.id + ')" class="checkbox" /><span class="username"><a href="' + tweet.profile_url + '" rel="external">' + tweet.from_user + '</a>:</span>';
            } else {
              html += '<p class="text"> ';
            }
