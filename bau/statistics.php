...
{
	$sql = "SELECT COUNT(*) AS count FROM tweets WHERE campaign_id='7' AND from_user = '".$from_user."' ";
...
<?php
$sql = "SELECT DISTINCT from_user,from_user_name FROM tweets WHERE campaign_id = '7'";
$result = mysql_query($sql) or die("Error code 93269591".mysql_error());
