...
<head>
	...
	<title>TweetDuvar.im - SailingBau</title>
...
border:#000 solid 2px;
    ...
    $(function() {
		$('.checkbox').live("click", function() {
			...
			if(this.checked)
			{
		 		$.post("validate.php", { tweet_id: id, val: 1, campaign_id: <?=$campaign_id?> });
			}
			else
...
<a href="projection.php?campaign_id=<?=$campaign_id;?>" class="button"> B a ş l a </a>
<a href="index.php?campaign_id=<?=$campaign_id;?>" class="button">İptal Edilen Tweetleri Temizle</a>
<a href="statistics.php?campaign_id=<?=$campaign_id;?>" class="button"> İstatistik </a>

<br /><br /><br><br><br>

<?php
$sql = "SELECT * FROM tweets WHERE is_active = '1' AND campaign_id = '".$campaign_id."' ORDER BY id DESC";
