...
<a href="approved.php?campaign_id=1" class="button">Clear Disapproved Tweets</a> 	
<br /><br /><br>

<?php
$sql = "SELECT * FROM tweets WHERE is_active = '1' ORDER BY view_count DESC";
