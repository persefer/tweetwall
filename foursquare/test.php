...
Fitslim Sport Center : 4caca53bd971b1f7a35a32e1<br><br>
    ...
    <a href="
https://foursquare.com/oauth2/authenticate?client_id=***&response_type=code&redirect_uri=http://www.tweetduvar.im/fitslim/test.php">
https://foursquare.com/oauth2/authenticate?client_id=***&response_type=code&redirect_uri=http://www.tweetduvar.im/fitslim/test.php</a><br><br>
...
if(isset($_REQUEST['code']) AND $_REQUEST['code'] != "")
{
    ...
    $a = file_get_contents("https://foursquare.com/oauth2/access_token?client_id=***&client_secret=***&grant_type=authorization_code&redirect_uri=http://www.tweetduvar.im/fitslim/test.php&code=".$_REQUEST['code']);
    echo sizeof($a)."<hr>";
    print_r($a)."<hr>";
    ...
    var_dump($json)."<hr>";
    echo "<a href=\"https://foursquare.com/oauth2/access_token?client_id=***&client_secret=***&grant_type=authorization_code&redirect_uri=http://www.tweetduvar.im/fitslim/test.php&code=".$_REQUEST['code']."\">get token</a><br><br>";
    ...
    curl_setopt($ch, CURLOPT_URL, "https://foursquare.com/oauth2/access_token?client_id=**&client_secret=***&grant_type=authorization_code&redirect_uri=http://www.tweetduvar.im/fitslim/test.php&code=".$_REQUEST['code']); //Bağlanacağı URL  
...
https://api.foursquare.com/v2/simulate/venues/***/stats?oauth_token=***&v=20130126
...
var auth_string = "&client_id=***&client_secret=***&v=20130110";
    var checkins = 0;
    var tips = 0;
...
https://api.foursquare.com/v2/venues/4caca53bd971b1f7a35a32e1/herenow?oauth_token=***&v=20130112
...
https://api.foursquare.com/v2/venues/***/herenow?oauth_token=***
