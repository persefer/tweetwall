...
$sql = "SELECT * FROM tweets WHERE id > '".$id_str_1."' AND is_active = '1' ORDER BY id ASC LIMIT 1";
...
{
	$sql = "SELECT * FROM tweets WHERE id > '0' AND is_active = '1' ORDER BY id ASC LIMIT 1";
	$result = mysql_query($sql) or die("Error code 93269591".mysql_error());
	if(mysql_num_rows($result))
	{
